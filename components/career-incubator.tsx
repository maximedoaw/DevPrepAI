...
export default function CareerIncubator() {
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            // Phase 0-1: Profil apparaît et descend vers l'incubateur (z-index 10)
            ...
            // Phase 1-2: Profil entre dans l'incubateur (passe derrière - z-index 5)
            ...
            // Phase 2: Profil à l'intérieur (transformation - z-index 5)
            tl.to(profileRef.current, {
                y: 0,
                scale: 0.6,
                opacity: 0.4,
            ...
            // Phase 3: Profil commence à ressortir (repasse devant - z-index 10)
            tl.to(profileRef.current, {
                y: 50,
                scale: 0.8,
                opacity: 1,
            ...
            // Phase 4: Profil transformé sort complètement (z-index 10)
            tl.to(profileRef.current, {
                y: 150,
                scale: 1.1,
                zIndex: 10,
            ...
            // Animation de l'incubateur (toujours z-index 8)
            ...
            <div className="relative z-10 h-full flex items-center justify-center">
                <div className="w-full max-w-5xl mx-auto px-6">
                    ...
                    <div className="relative flex items-center justify-center h-[500px]">
                        {/* Incubateur de carrière (z-index 8) */}
                        <div 
                            ref={acceleratorRef}
                        ...
                        {/* Carte profil (z-index dynamique: 10 dehors, 5 dedans) */}
                        <Card 
                            ref={profileRef}
                        ...
                        >
                            ...
                            <div className="flex justify-center mb-4">
                                <div className={`relative w-28 h-28 rounded-2xl overflow-hidden ring-4 ring-offset-2 ring-offset-white dark:ring-offset-slate-800 transition-all duration-1000 ${
                                    phase >= 4 ? 'ring-green-500' : 
                                    phase >= 3 ? 'ring-emerald-500' :
                                    phase >= 2 ? 'ring-purple-500' :
                                    phase >= 1 ? 'ring-indigo-500' : 'ring-blue-500'
                                }`}>
                                    <img 
                                        src={phase >= 4 ? "/img2.png" : "/img1.jpeg"} 
                                        alt="Profil"
                            ...
                            <div className="text-center mb-4">
                                ...
                                <p className="text-sm text-slate-600 dark:text-slate-400">
                                    {phase >= 4 ? "Employé" : "Chercheur d'emploi"}
                                </p>
                            </div>

                            {/* Statut */}
                            <div className={`p-3 rounded-xl bg-gradient-to-r ${current.gradient} text-white text-center text-sm font-semibold transition-all duration-500`}>
                                {current.subtitle}
                            </div>
